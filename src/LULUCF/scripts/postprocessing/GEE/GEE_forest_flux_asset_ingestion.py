...
python -m src.utilities.create_cluster -cn forest_flux_gee_assets -n 10 -m 4 --gcp
python -m src.LULUCF.scripts.postprocessing.GEE.GEE_forest_flux_asset_ingestion -cn forest_flux_gee_assets -d emissions removals net_flux -b lulucf -f v1-4-3-2001-2025 -r projects/wri-datalab/gfw-data-lake/

Run locally after QC to delete tiles from GCS + make assets public:
python -m src.LULUCF.scripts.postprocessing.GEE.GEE_forest_flux_asset_ingestion -d emissions removals net_flux -b lulucf -f v1-4-3-2001-2025 -r projects/wri-datalab/gfw-data-lake/ --skip_existing --clean_gcs --make_public

Notes:
    - Took 20 minutes for all three forest flux layers.
