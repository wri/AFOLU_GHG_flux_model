...
python -m src.LULUCF.scripts.zonal_statistics.4_SOC_zonal_stats -cn SOC_zonal_stats -bb 10 49 11 50 -fv 2 -ft 2 -mt standard -mpd global --input_date YYYYMMDD -zd test_box --veg_input_date 20260130 --veg_model_version 1.0.05 --veg_model_type standard --veg_model_path_description global -mcstn KEEP_definitive_runs/SOC_density/v1_0_1__2000_2022__20260611/soil_carbon_densities_and_changes_1x1_chunk_statistics_20260526_15_43_37__with_pivots__KEEP.xlsx

Coiled 8-tile test (Central and East Africa):
python -m src.utilities.create_cluster -n 50 -m 32 -cn SOC_zonal_stats --zonal_stats
python -m src.LULUCF.scripts.zonal_statistics.4_SOC_zonal_stats -cn SOC_zonal_stats -bb 13 -14 44 -3 -fv 3 -ft 3 -mt standard -mpd global --input_date YYYYMMDD -zd Central_Africa_test  -mcstn KEEP_definitive_runs/SOC_density/v1_0_1__2000_2022__20260611/soil_carbon_densities_and_changes_1x1_chunk_statistics_20260526_15_43_37__with_pivots__KEEP.xlsx

Coiled Cerrado test (174 features):
python -m src.utilities.create_cluster -n 50 -m 32 -cn SOC_zonal_stats --zonal_stats
python -m src.LULUCF.scripts.zonal_statistics.4_SOC_zonal_stats -cn SOC_zonal_stats -mt standard -mpd global --input_date YYYYMMDD -zd Cerrado_test -cshp s3://gfw2-data/climate/AFOLU_flux_model/fishnet_1x1deg/20250429/fishnet_GADM41_1x1deg__spatial_join_intersect__20250428__center_in__Cerrado_center_in.shp
